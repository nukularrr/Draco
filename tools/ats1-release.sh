...
logfile="${source_prefix:-notset}/logs/release-$buildflavor-$rttversion-cb${jobnameext}.log"
...
cmd="sbatch -J rel-${package:0:3}-${buildflavor: -10}-$rttversion -t 8:00:00 -N 1 ${partition} \
