...
double F12(double x) {
  ...
  const double a1[] = {
      ...
      6.42493233715640e5, 4.16031909245777e4, 7.77238678539648e2, 1.0e0};
  const double b1[] = {6.49759261942269e6, 1.70750501625775e7, 1.69288134856160e7,
  ...
  const double a2[] = {4.85378381173415e-14,
                       ...
                       1.91247528779676e0,
                       1.0e0};
  const double b2[] = {7.28067571760518e-14, 2.45745452167585e-11, 5.62152894375277e-9,
