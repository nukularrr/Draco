...
template <class OrderedField> OrderedField FM12(OrderedField const &x) {
  ...
  const double b1[] = {9.67282587452899e6, 2.87386436731785e7, 3.26070130734158e7,
                       1.77657027846367e7, 4.81648022267831e6, 6.13709569333207e5,
                       3.13595854332114e4, 4.35061725080755e2};
  const double a2[] = {-4.46620341924942e-15, -1.58654991146236e-12, -4.44467627042232e-10,
  ...
  const double b2[] = {-2.23310170962369e-15, -7.94193282071464e-13, -2.22564376956228e-10,
