...
template <class OrderedField> OrderedField F32(OrderedField const &x) {
  ...
  const double a1[] = {4.32326386604283e4,
                       ...
                       9.90562948053193e1,
                       1.0e0};
  const double b1[] = {3.25218725353467e4, 7.01022511904373e4, 5.50859144223638e4,
                       1.95942074576400e4, 3.20803912586318e3, 2.20853967067789e2,
  ...
  const double b2[] = {7.01131732871184e-13, 2.10699282897576e-10, 3.94452010378723e-8,
