...
# date   2010 June 5
# brief  Establish flags for Visual Studio on Windows. These settings are shared
#        by cl.exe and clang-cl.exe.
...
if( NOT ${CMAKE_GENERATOR} MATCHES "Visual Studio" AND
  ...
  message( FATAL_ERROR
  "config/windows-msvc.cmake must be taught to build for this compiler "
...
if( NOT CXX_FLAGS_INITIALIZED )
  ...
  set( CMAKE_C_FLAGS "/Gy /fp:precise /DWIN32 /D_WINDOWS /MP /wd4251" )
...
function(force_compiler_flags_to_cache)
  ...
  set( DRACO_LINK_OPTIONS "${DRACO_LINK_OPTIONS}" CACHE
    STRING "link flags" FORCE)
